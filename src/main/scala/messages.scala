...
case class CommitRequest(objects: Map[Proxy, Shared[Int]]) extends Message
case class Commit() extends Message
case class Abort() extends Message
case class AbortWithList(objects: Set[(Proxy,Shared[Int])]) extends Message
case class CanCommit(objects: Set[(Proxy,Shared[Int])])
...
case class WriteCommit(objects: Set[(Proxy,Shared[Int])])